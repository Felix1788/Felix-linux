...
banner() {
	clear
	cat <<- EOF
   ${Y}_____ _____ _     _____  __  _____ _   _ _____    ____    _  _____
      |  ___| ____| |   |_ _\ \/ / |_   _| | | | ____|  / ___|  / \|_   _|
  ${C}| |_  |  _| | |    | | \  /    | | | |_| |  _|   | |     / _ \ | |
      |  _| | |___| |___ | | /  \    | | |  _  | |___  | |___ / ___ \| | 
  ${G}|_|   |_____|_____|___/_/\_\   |_| |_| |_|_____|  \____/_/   \_\_|        

	EOF
	echo -e "${G}     A modded gui version of pardus for Termux\n\n"${W}
}
